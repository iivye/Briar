...
import me.iivye.plugin.briarmarket.datastore.DataStorage;
import me.iivye.plugin.briarmarket.datastore.others.JSONDataStorage;
import me.iivye.plugin.briarmarket.datastore.others.MongoDataStorage;
import me.iivye.plugin.briarmarket.datastore.others.MySQLDataStorage;
import me.iivye.plugin.briarmarket.datastore.others.SQLiteDataStorage;
import me.iivye.plugin.briarmarket.parser.GUIParser;
import me.iivye.plugin.briarmarket.schedule.access.AccessScheduleManager;
import me.iivye.plugin.briarmarket.schedule.rotate.RotateScheduleManager;
import me.iivye.plugin.briarmarket.shop.item.ShopItemRegistry;
import me.iivye.plugin.briarmarket.shop.player.PlayerShopManager;
import me.iivye.plugin.briarmarket.util.UpdateChecker;
import me.iivye.plugin.briarmarket.util.dependency.IsolatedClass;
import me.iivye.plugin.briarmarket.util.dependency.LibraryLoader;
...
public final class Briar extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        new CommandParser(getResource("commands.rdcml")).parse().register(this, "briarmarket", new CMDHooks(this));
